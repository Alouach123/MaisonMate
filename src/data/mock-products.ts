...
export let mockProducts: Product[] = [
  {
    ...
    price: 699.99,
    imageUrl: 'https://img.freepik.com/free-photo/elegant-white-sofa-spacious-living-room-with-beautiful-view_1217-2018.jpg',
    category: 'Sofas',
    style: 'Modern',
    rating: 4.5,
  ...
  },
  {
    ...
    price: 129.99,
    imageUrl: 'https://img.freepik.com/premium-psd/modern-chair-transparent-background_939509-593.jpg',
    category: 'Chairs',
    style: 'Minimalist',
    rating: 4.8,
    materials: ['Oak Wood'],
  ...
  },
  {
    ...
    price: 349.50,
    imageUrl: 'https://placehold.co/600x400.png', // Placeholder - Specific rustic cabinet needed
    category: 'Cabinets',
    style: 'Rustic',
    rating: 4.2,
  ...
  },
  {
    ...
    price: 189.00,
    imageUrl: 'https://img.freepik.com/free-photo/minimalist-wooden-coffee-table-living-room-decor_53876-143396.jpg',
    category: 'Tables',
    style: 'Scandinavian',
    rating: 4.6,
  ...
  },
  {
    ...
    price: 259.99,
    imageUrl: 'https://img.freepik.com/free-psd/modern-wooden-bookshelf-isolated-transparent-background_191095-11960.jpg',
    category: 'Cabinets',
    style: 'Industrial',
    rating: 4.3,
  ...
  },
  {
    ...
    price: 299.00,
    imageUrl: 'https://img.freepik.com/free-photo/comfortable-eco-friendly-rattan-armchair_176474-9419.jpg',
    category: 'Chairs',
    style: 'Bohemian',
    rating: 4.7,
  ...
  },
   {
    ...
    price: 450.00,
    imageUrl: 'https://placehold.co/600x400.png', // Placeholder - Specific Chesterfield needed
    category: 'Chairs',
    style: 'Classic',
    rating: 4.9,
    colors: ["Brown", "Black"],
  ...
  },
  {
    ...
    price: 399.99,
    imageUrl: 'https://img.freepik.com/free-photo/modern-dining-room-interior-design_53876-126009.jpg',
    category: 'Tables',
    style: 'Modern',
    rating: 4.4,
  ...
  },
  {
    ...
    price: 159.99,
    imageUrl: 'https://placehold.co/600x400.png', // Placeholder - Specific lamp needed
    category: 'Lighting',
    style: 'Art Deco',
    rating: 4.7,
    colors: ['Brass', 'White'],
  ...
  },
  {
    ...
    price: 289.00,
    imageUrl: 'https://img.freepik.com/free-photo/detailed-shot-colorful-rug-made-natural-wool_181624-14744.jpg',
    category: 'Rugs',
    style: 'Modern',
    rating: 4.5,
  ...
  },
  {
    ...
    price: 599.00,
    imageUrl: 'https://img.freepik.com/free-photo/luxury-bedroom-suite-resort-high-rise-hotel-with-working-table_105762-1783.jpg',
    category: 'Beds',
    style: 'Contemporary',
    rating: 4.6,
