...
export let mockProducts: Product[] = [
  ...
  },
  {
    ...
    category: 'Cabinets', // Or Bookshelves if we add that category
    style: 'Industrial',
    rating: 4.3,
  ...
  },
  {
    ...
    price: 299.00,
    imageUrl: 'https://images.unsplash.com/photo-1600585152220-90363fe7e115?q=80&w=600&h=400&auto=format&fit=crop', // Generic living room, rattan might be harder to find specific
    category: 'Chairs',
    style: 'Bohemian',
    rating: 4.7,
  ...
  },
   {
    ...
    price: 450.00,
    imageUrl: 'https://images.unsplash.com/photo-1567016432779-094069958ea5?q=80&w=600&h=400&auto=format&fit=crop', // Example of classic armchair
    category: 'Chairs',
    style: 'Classic',
    rating: 4.9,
    colors: ["Brown", "Black"],
  ...
  },
  {
    ...
    price: 159.99,
    imageUrl: 'https://images.unsplash.com/photo-1507402208745-de42690f1091?q=80&w=600&h=400&auto=format&fit=crop', // Example of a stylish lamp
    category: 'Lighting',
    style: 'Art Deco',
    rating: 4.7,
    colors: ['Brass', 'White'],
